...
class SpinnerAsanaCounterEightAdapter(
  private val mContext: Context,
  @LayoutRes
  private val layoutResource: Int,
  private val allItems: List<SpinnerAsanaCounterEightModel>
) : ArrayAdapter<SpinnerAsanaCounterEightModel>(mContext, layoutResource, allItems) {
