...
class SpinnerLanguageThreeAdapter(
  private val mContext: Context,
  @LayoutRes
  private val layoutResource: Int,
  private val allItems: List<SpinnerLanguageThreeModel>
) : ArrayAdapter<SpinnerLanguageThreeModel>(mContext, layoutResource, allItems) {
