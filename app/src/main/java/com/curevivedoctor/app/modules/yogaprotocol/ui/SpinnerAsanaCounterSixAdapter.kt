...
class SpinnerAsanaCounterSixAdapter(
  private val mContext: Context,
  @LayoutRes
  private val layoutResource: Int,
  private val allItems: List<SpinnerAsanaCounterSixModel>
) : ArrayAdapter<SpinnerAsanaCounterSixModel>(mContext, layoutResource, allItems) {
