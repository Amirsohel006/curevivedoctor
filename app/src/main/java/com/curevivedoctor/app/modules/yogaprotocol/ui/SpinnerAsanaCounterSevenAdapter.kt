...
class SpinnerAsanaCounterSevenAdapter(
  private val mContext: Context,
  @LayoutRes
  private val layoutResource: Int,
  private val allItems: List<SpinnerAsanaCounterSevenModel>
) : ArrayAdapter<SpinnerAsanaCounterSevenModel>(mContext, layoutResource, allItems) {
