package com.curevivedoctor.app.modules.profilecodelink.`data`.model

import com.curevivedoctor.app.R
import com.curevivedoctor.app.appcomponents.di.MyApp
import kotlin.String

data class ProfileCodeLinkModel(
  /**
   ...
   * TODO Replace with dynamic value
   */
  var txtWeburl: String? = MyApp.getInstance().resources.getString(R.string.msg_www_curevive_in)
