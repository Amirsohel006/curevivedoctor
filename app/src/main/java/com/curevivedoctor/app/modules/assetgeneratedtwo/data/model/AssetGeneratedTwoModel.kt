package com.curevivedoctor.app.modules.assetgeneratedtwo.`data`.model

import com.curevivedoctor.app.R
import com.curevivedoctor.app.appcomponents.di.MyApp
import kotlin.String

data class AssetGeneratedTwoModel(
  /**
   * TODO Replace with dynamic value
   */
  var txtReferalincome: String? =
      MyApp.getInstance().resources.getString(R.string.lbl_referal_income)
  ,
  /**
   * TODO Replace with dynamic value
   */
