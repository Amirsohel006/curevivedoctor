package com.curevivedoctor.app.modules.walletfines.`data`.model

import com.curevivedoctor.app.R
import com.curevivedoctor.app.appcomponents.di.MyApp
import kotlin.String

data class WalletFinesModel(
  /**
   ...
   * TODO Replace with dynamic value
   */
  var txtFinesOne: String? = MyApp.getInstance().resources.getString(R.string.lbl_fines)
  ,
  /**
   * TODO Replace with dynamic value
   */
   ...
   * TODO Replace with dynamic value
   */
  var txtLanguage: String? = MyApp.getInstance().resources.getString(R.string.lbl_daniel_clark)
  ,
  /**
   * TODO Replace with dynamic value
   */
  var txt5000: String? = MyApp.getInstance().resources.getString(R.string.lbl_5000)
  ,
  /**
   * TODO Replace with dynamic value
   */
  var txtLawren: String? = MyApp.getInstance().resources.getString(R.string.lbl_lawren)
  ,
  /**
   * TODO Replace with dynamic value
   */
  var txt2000: String? = MyApp.getInstance().resources.getString(R.string.lbl_2000)
