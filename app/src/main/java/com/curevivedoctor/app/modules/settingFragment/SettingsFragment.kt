package com.curevivedoctor.app.modules.settingFragment
...
import com.curevivedoctor.app.modules.settings.ui.SettingsAdapter
...
class SettingsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_settings, container, false).apply {
            ...
            val recyclerSettings=findViewById<RecyclerView>(R.id.recyclerSettings)
